...
class ProfessorsControllerTest < ActionController::TestCase
  ...
  test "should create professor" do
    assert_difference('Professor.count') do
      post :create, professor: { lname2: @professor.lname2, lname: @professor.lname, name: @professor.name, worker: @professor.worker }
    end
  ...
  test "should update professor" do
    patch :update, id: @professor, professor: { lname2: @professor.lname2, lname: @professor.lname, name: @professor.name, worker: @professor.worker }
    assert_redirected_to professor_path(assigns(:professor))
  end
